...
# 10. Initialize the LinearRegression model.
...
# 14. Print the coefficients of the LinearRegression model
print("\nCác hệ số của mô hình LinearRegression:")
...
sample_total_volumes = [39067019.49 , 18353216.27
, 5000000, 10000000]
sample_market_caps = [3731239757, 3530339614
